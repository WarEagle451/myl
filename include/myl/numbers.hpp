...
namespace myl::numbers {
#ifdef MYL_ROUND_CONSTANTS
	template<typename T> inline constexpr T e					= static_cast<T>(2.7182818284590452353602874713527); //@brief Euler's number
	...
	template<typename T> inline constexpr T egamma				= static_cast<T>(1.7810724179901979852365041031072); //@brief e^euler
	template<typename T> inline constexpr T golden_ratio		= static_cast<T>(1.6180339887498948482045868343656); //@brief Phi

	template<typename T> inline constexpr T half_pi				= static_cast<T>(1.5707963267948966192313216916398);
	...
	template<typename T> inline constexpr T inverse_sqrt_pi		= static_cast<T>(0.5641895835477562869480794515608);
	template<typename T> inline constexpr T pi					= static_cast<T>(3.1415926535897932384626433832795);
	template<typename T> inline constexpr T quater_pi			= static_cast<T>(0.7853981633974483096156608458199);
	template<typename T> inline constexpr T sqrt_pi				= static_cast<T>(1.7724538509055160272981674833411);
	template<typename T> inline constexpr T two_over_pi			= static_cast<T>(0.6366197723675813430755350534901);
	...
	template<typename T> inline constexpr T inverse_sqrt3		= static_cast<T>(0.5773502691896257645091487805020); //@brief Inverse square root of 3
	template<typename T> inline constexpr T ln2					= static_cast<T>(0.6931471805599453094172321214582); //@brief Natural log of 2
	template<typename T> inline constexpr T ln10				= static_cast<T>(2.3025850929940456840179914546844); //@brief Natural log of 2
	template<typename T> inline constexpr T log2e				= static_cast<T>(1.4426950408889634073599246810019);
	template<typename T> inline constexpr T log10e				= static_cast<T>(0.4342944819032518276511289189166);
	template<typename T> inline constexpr T sqrt2				= static_cast<T>(1.4142135623730950488016887242097); //@brief Square root of 2, Pythagoras constant
	template<typename T> inline constexpr T sqrt3				= static_cast<T>(1.7320508075688772935274463415059); //@brief Square root of 3, Theodorus' constant
	template<typename T> inline constexpr T sqrt5				= static_cast<T>(2.2360679774997896964091736687313); //@brief Square root of 5
	...
	template<floating_point T> inline constexpr T infinity			= static_cast<T>(1) / static_cast<T>(0);
	template<floating_point T> inline constexpr T negative_infinity	= -infinity<T>;
}