...
namespace myl {
    ...
    public:
        ...
        MYL_NO_DISCARD constexpr mat(
            ...
            const value_type& c0r2, const value_type& c1r2, const value_type& c2r2, const value_type& c3r2) noexcept
            : m_data{ column_type{ c0r0, c0r1, c0r2 }, column_type{ c1r0, c1r1, c1r2 }, column_type{ c2r0, c2r1, c2r2 }, column_type{ c3r0, c3r1, c3r2 } } {}
        ...
        MYL_NO_DISCARD constexpr mat(
            ...
            value_type&& c0r2, value_type&& c1r2, value_type&& c2r2, value_type&& c3r2) noexcept
            : m_data{ column_type{ std::move(c0r0), std::move(c0r1), std::move(c0r2) }, column_type{ std::move(c1r0), std::move(c1r1), std::move(c1r2) }, column_type{ std::move(c2r0), std::move(c2r1), std::move(c2r2) }, column_type{ std::move(c3r0), std::move(c3r1), std::move(c3r2) } } {}
