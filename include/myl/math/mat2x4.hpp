...
namespace myl {
    ...
    public:
        ...
        MYL_NO_DISCARD constexpr mat(
            ...
            const value_type& c0r2, const value_type& c1r2,
            const value_type& c0r3, const value_type& c1r3) noexcept
            : m_data{ column_type{ c0r0, c0r1, c0r2, c0r3 }, column_type{ c1r0, c1r1, c1r2, c1r3 } } {}

        MYL_NO_DISCARD constexpr mat(
            value_type&& c0r0, value_type&& c1r0,
            value_type&& c0r1, value_type&& c1r1,
            value_type&& c0r2, value_type&& c1r2,
            value_type&& c0r3, value_type&& c1r3) noexcept
            : m_data{ column_type{ std::move(c0r0), std::move(c0r1), std::move(c0r2), std::move(c0r3) }, column_type{ std::move(c1r0), std::move(c1r1), std::move(c1r2), std::move(c1r3) } } {}
