...
namespace myl {
    namespace color {
        ...
        MYL_NO_DISCARD constexpr auto hsv_to_cmy(const f32vec3& color) -> f32vec3 {
            return hsv_to_rgb({ 1.f - color.r, 1.f - color.g, 1.f - color.b });
        }
    ...
    template<color::model From, color::model To> MYL_NO_DISCARD constexpr auto color_cast(const color::model_structure<From>& color) -> color::model_structure<To>;
    
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::cmy, color::model::cmy>(const f32vec3& color) ->  f32vec3 { return color; }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::cmy, color::model::cmyk>(const f32vec3& color) -> f32vec4 { return color::cmy_to_cmyk(color); }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::cmy, color::model::rgb>(const f32vec3& color) ->  f32vec3 { return color::cmy_to_rgb(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::cmy, color::model::rgba>(const f32vec3& color) -> f32vec4 { return color::cmy_to_rgba(color); }

    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::cmyk, color::model::cmy>(const f32vec4& color) ->  f32vec3 { return color::cmyk_to_cmy(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::cmyk, color::model::cmyk>(const f32vec4& color) -> f32vec4 { return color; }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::cmyk, color::model::rgb>(const f32vec4& color) ->  f32vec3 { return color::cmyk_to_rgb(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::cmyk, color::model::rgba>(const f32vec4& color) -> f32vec4 { return color::cmyk_to_rgba(color); }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::hsl, color::model::hsl>(const f32vec3& color) ->  f32vec3 { return color; }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::hsl, color::model::hsv>(const f32vec3& color) ->  f32vec3 { return color::hsl_to_hsv(color); }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::hsl, color::model::rgb>(const f32vec3& color) ->  f32vec3 { return color::hsl_to_rgb(color); }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::hsv, color::model::hsl>(const f32vec3& color) ->  f32vec3 { return color::hsv_to_hsl(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::hsv, color::model::hsv>(const f32vec3& color) ->  f32vec3 { return color; }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::hsv, color::model::rgb>(const f32vec3& color) ->  f32vec3 { return color::hsv_to_rgb(color); }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::lab, color::model::lab>(const f32vec3& color) ->  f32vec3 { return color; }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::lab, color::model::rgb>(const f32vec3& color) ->  f32vec3 { return color::lab_to_rgb(color); }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgb, color::model::cmy>(const f32vec3& color) ->  f32vec3 { return color::rgb_to_cmy(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgb, color::model::cmyk>(const f32vec3& color) -> f32vec4 { return color::rgb_to_cmyk(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgb, color::model::hsl>(const f32vec3& color) ->  f32vec3 { return color::rgb_to_hsl(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgb, color::model::hsv>(const f32vec3& color) ->  f32vec3 { return color::rgb_to_hsv(color); }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgb, color::model::rgb>(const f32vec3& color) ->  f32vec3 { return color; }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgb, color::model::rgba>(const f32vec3& color) -> f32vec4 { return color::rgb_to_rgba(color); }

    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgba, color::model::cmy>(const f32vec4& color) ->  f32vec3 { return color::rgba_to_cmy(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgba, color::model::cmyk>(const f32vec4& color) -> f32vec4 { return color::rgba_to_cmyk(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgba, color::model::hsl>(const f32vec4& color) ->  f32vec3 { return color::rgba_to_hsl(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgba, color::model::hsv>(const f32vec4& color) ->  f32vec3 { return color::rgba_to_hsv(color); }
    ...
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgba, color::model::rgb>(const f32vec4& color) ->  f32vec3 { return color::rgba_to_rgb(color); }
    template<> MYL_NO_DISCARD constexpr auto color_cast<color::model::rgba, color::model::rgba>(const f32vec4& color) -> f32vec4 { return color; }
}
